...
const MEDITATION_TYPES = [
  { name: 'Breathing', description: 'Focus on your breath', icon: '🌬️', sound: '/sounds/ambient-breathing.mp3', likes: 0, dislikes: 0 },
  { name: 'Body Scan', description: 'Awareness of physical sensations', icon: '🧘‍♀️', sound: '/sounds/ambient-body-scan.mp3', likes: 0, dislikes: 0 },
  { name: 'Loving-Kindness', description: 'Cultivate compassion', icon: '💝', sound: '/sounds/ambient-loving-kindness.mp3', likes: 0, dislikes: 0 },
  { name: 'Mindfulness', description: 'Present moment awareness', icon: '🍃', sound: '/sounds/ambient-mindfulness.mp3', likes: 0, dislikes: 0 },
];
...
export default function MeditationTimer() {
  ...
  const [meditationFeedback, setMeditationFeedback] = useState<{[key: string]: {likes: number, dislikes: number}}>(() => {
    const initialFeedback: {[key: string]: {likes: number, dislikes: number}} = {};
    MEDITATION_TYPES.forEach(type => {
      initialFeedback[type.name] = { likes: 0, dislikes: 0 };
    });
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      <div className="flex flex-col items-center p-12 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-blue-900 rounded-3xl shadow-xl">
        <h1 className="text-4xl font-bold mb-2 text-gray-800 dark:text-white">Peaceful Mind</h1>
        <p className="text-gray-600 dark:text-gray-300 mb-8">Take a moment to breathe and center yourself</p>
